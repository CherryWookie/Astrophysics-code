...
o_thin_mcm17 = Orbit(**get_physical(McMillan17))
o_thin_irrI = Orbit(**get_physical(Irrgang13I))
o_thin.integrate(ts,MWPotential2014)
o_thin_mcm17.integrate(ts,McMillan17)
o_thin_irrI.integrate(ts,Irrgang13I)

o_thick = Orbit(star_thick[0], ro=R0, zo=z0, vo=V0, solarmotion=v_sun)
o_thick_mcm17 = Orbit(**get_physical(McMillan17))
o_thick_irrI = Orbit(**get_physical(Irrgang13I))
o_thick.integrate(ts,MWPotential2014)
o_thick_mcm17.integrate(ts,McMillan17)
o_thick_irrI.integrate(ts,Irrgang13I)

o_halo = Orbit(star_halo[0], ro=R0, zo=z0, vo=V0, solarmotion=v_sun)
o_halo_mcm17 = Orbit(**get_physical(McMillan17))
o_halo_irrI = Orbit(**get_physical(Irrgang13I))
o_halo.integrate(ts,MWPotential2014)
o_halo_mcm17.integrate(ts,McMillan17)
o_halo_irrI.integrate(ts,Irrgang13I)
...
print('e = ', o_thin_mcm17.e(), 'Lz = ', o_thin.Lz(quantity=True))
print('e = ', o_thick_mcm17.e(), 'Lz = ', o_thick.Lz(quantity=True))
print('e = ', o_halo_mcm17.e(), 'Lz = ', o_halo.Lz(quantity=True))

print('e = ', o_thin_irrI.e(), 'Lz = ', o_thin.Lz(quantity=True))
print('e = ', o_thick_irrI.e(), 'Lz = ', o_thick.Lz(quantity=True))
print('e = ', o_halo_irrI.e(), 'Lz = ', o_halo.Lz(quantity=True))
...
# Plotting orbits McMillan17
fig = pl.figure(figsize=(14,6))
fig.subplots_adjust(wspace=0.3)

ax1 = fig.add_subplot(121)
ax1.plot(o_halo_mcm17.R(ts,quantity=True),o_halo.z(ts,quantity=True))
ax1.plot(o_thick_mcm17.R(ts,quantity=True),o_thick.z(ts,quantity=True))
ax1.plot(o_thin_mcm17.R(ts,quantity=True),o_thin.z(ts,quantity=True))
ax1.set_xlabel('R [kpc]')
ax1.set_ylabel('Z [kpc]')

ax2 = fig.add_subplot(122)
ax2.plot(o_halo_mcm17.y(ts,quantity=True),o_halo.x(ts,quantity=True), label='halo')
ax2.plot(o_thick_mcm17.y(ts,quantity=True),o_thick.x(ts,quantity=True), label='thick disk')
ax2.plot(o_thin_mcm17.y(ts,quantity=True),o_thin.x(ts,quantity=True), label='thin disk')
ax2.set_xlabel('Y [kpc]')
ax2.set_ylabel('X [kpc]')
ax2.invert_xaxis()
ax2.invert_yaxis()
...
# Plotting Orbits Irrgang
fig = pl.figure(figsize=(14,6))
fig.subplots_adjust(wspace=0.3)

ax1 = fig.add_subplot(121)
ax1.plot(o_halo_irrI.R(ts,quantity=True),o_halo.z(ts,quantity=True))
ax1.plot(o_thick_irrI.R(ts,quantity=True),o_thick.z(ts,quantity=True))
ax1.plot(o_thin_irrI.R(ts,quantity=True),o_thin.z(ts,quantity=True))
ax1.set_xlabel('R [kpc]')
ax1.set_ylabel('Z [kpc]')

ax2 = fig.add_subplot(122)
ax2.plot(o_halo_irrI.y(ts,quantity=True),o_halo.x(ts,quantity=True), label='halo')
ax2.plot(o_thick_irrI.y(ts,quantity=True),o_thick.x(ts,quantity=True), label='thick disk')
ax2.plot(o_thin_irrI.y(ts,quantity=True),o_thin.x(ts,quantity=True), label='thin disk')
ax2.set_xlabel('Y [kpc]')
ax2.set_ylabel('X [kpc]')
ax2.invert_xaxis()
ax2.invert_yaxis()
...
R_thin = a_thin.R(ts[time_index])  # R in kpc
Z_thin = a_thin.z(ts[time_index])  # Z in kpc

R_thick = a_thick.R(ts[time_index])
Z_thick = a_thick.z(ts[time_index])

R_halo = a_halo.R(ts[time_index])
Z_halo = a_halo.z(ts[time_index])
...
# obtain positions R and Z at that moment
R_thin = a_thin.R(ts[time_index])  # R en kpc
Z_thin = a_thin.z(ts[time_index])  # Z en kpc
...
# obtain positions R and Z at that moment
R_stars = a_stars.R(ts[time_index])  # R en kpc
Z_stars = a_stars.z(ts[time_index])  # Z en kpc
